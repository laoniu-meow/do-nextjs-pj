...
// GET /api/admin/shop/suppliers/staging/[id] - get specific staging supplier
...
// PUT /api/admin/shop/suppliers/staging/[id] - update staging supplier (full update)
...
// PATCH /api/admin/shop/suppliers/staging/[id] - partial update staging supplier
...
// DELETE /api/admin/shop/suppliers/staging/[id] - delete staging supplier
