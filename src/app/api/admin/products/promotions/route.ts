...
// GET /api/admin/products/promotions - list all production promotions (same pattern as tax and supplier)
...
// POST /api/admin/products/promotions - create promotion (same pattern as tax and supplier)
